**Table of Contents**  
[1\. HTML Boilerplate](#h.mog5kz6ri7ei)  
[2\. Headings, Paragraphs, Lists, Tables](#h.ockr0qwyt9je)  
[3\. Forms](#h.38nxjkj5m4vf)  
[4\. Semantic HTML](#h.j54ah3o33jo9)  
[5\. Meta Tags & SEO Basics](#h.phv74qss1w99)  
[6\. HTML5 Form Validation](#h.lz3pkp33evdj)  
[Bonus Questions (Added for Complete Coverage)](#h.ddwi9sfv0761)

## [CSS (Styling & Layouts) — MERN Stack Interview Kit](#h.5yzyj4np1cao)

[1\. Selectors & Specificity](#h.4v4ehjemcr91)  
[2\. Box Model](#h.8to61yp8203)  
[3\. Display](#h.y9vp2srfrph8)  
[4\. Positioning](#h.tehvkyra3o84)  
[5\. Media Queries](#h.bbdx9b43fnv5)  
[6\. Transitions & Animations](#h.u70s3iwihp57)  
[Bonus Questions (Added for Complete Coverage)](#h.f8lj2hbwwzw4)

## [JavaScript (JS) — MERN Stack Interview Kit](#h.wxbxcbxbt0i6)

[1\. Variables (var, let, const)](#h.zicbl2ipn3tg)  
[2\. Data Types](#h.co6iy8wa0tb)  
[3\. Operators & Type Coercion](#h.5p5c52w5ppuh)  
[4\. Functions](#h.lkdsboeetndo)  
[5\. Scope & Hoisting](#h.4hwqe1zdq4tl)  
[6\. ES6+ Features](#h.ovfc3hno460g)  
[7\. Promises & Async/Await](#h.7op2tlvv8fwg)  
[8\. Fetch API & Axios](#h.kjw48kbl54u5)  
[9\. DOM Manipulation & Events](#h.odkhfniw1y6f)  
[10\. Error Handling](#h.tq6lvntfvvih)  
[11\. Closures & Lexical Scope](#h.3e4k055ps39u)  
[12\. Event Loop & Asynchronous JS](#h.f7hbs0kw5c25)  
[13\. Modules](#h.bfgni7chd9d7)  
[14\. Object-Oriented Programming (OOP)](#h.1lbr8m44onpt)  
[15\. Functional Programming](#h.grbez1mjf7i)  
[16\. Web Storage](#h.xfw0ff5ip9l8)  
[Bonus Questions (Added for Complete Coverage)](#h.glfj8r7hn7ab)

## [Node.js— MERN Stack Interview Kit](#h.1pmqvs3lo17n)

[1\. Node.js Fundamentals](#h.gwe6axnbnsjy)  
[2\. NPM & Yarn](#h.uz1vv1968kiq)  
[3\. Node.js Modules (CommonJS vs ES Modules)](#h.st067ujc9mb7)  
[4\. Asynchronous JavaScript in Node.js](#h.rl51kfdgnpp1)  
[5\. Event Loop & Streams](#h.9lke7xzehbkz)  
[6\. File System (fs module)](#h.bx2jftfgzzs)  
[7\. Environment Variables & Configuration](#h.c9w3oblo6qkq)  
[8\. Debugging & Logging](#h.g4rjkjkopn8s)  
[Bonus Questions](#h.ikypnboepu2l)

## [Express.js — MERN Stack Interview Kit](#h.pyeg96xmw1dg)

[1\. Setting Up an Express Server](#h.ilz3ngfwxl7c)  
[2\. Middleware](#h.8sk3w5ku7o09)  
[3\. Routing & Route Parameters](#h.bpqd71sovtt9)  
[4\. Request and Response Objects](#h.qfy5eow1h67z)  
[5\. Error Handling in Express](#h.w4fng4t1qkxy)  
[6\. RESTful APIs & CRUD Operations](#h.js6cklox0l0n)  
[7\. Request Body & Query Parameters](#h.5fc8d9ojpv0)  
[8\. HTTP Status Codes & Response Handling](#h.kqdrggn5cfs8)  
[Bonus Questions (Added for Complete Coverage)](#h.2pjuir83ia3b)

## [Authentication & Authorization — MERN Stack Interview Kit](#h.24a6wwka3t78)

[1\. OAuth & Google/Facebook Login (Passport.js)](#h.589yb1rzg1vs)  
[2\. Role-Based Access Control (RBAC)](#h.qho4r2jfx1mk)  
[3\. Session & Cookie Management](#h.10tvu1ulnaig)  
[Bonus Questions (Added for Complete Coverage)](#h.jc3eq4g4n0kv)

## [Advanced Express.js — MERN Stack Interview Kit](#h.fj1jo3iflnvq)

[1\. File Uploading (Multer, Cloudinary, AWS S3)](#h.a9vw3mmrluwk)  
[2\. Rate Limiting & Security Best Practices](#h.bs2vreb4euou)  
[3\. Caching (Redis)](#h.l96ixs6i7zc1)  
[4\. WebSockets (Socket.io)](#h.2os84sb1zxen)  
[5\. API Documentation](#h.yomlvf3k7ozj)  
[6\. Testing (Jest, Supertest, Mocha)](#h.n74z1zul5g87)  
[Bonus Questions (Added for Complete Coverage)](#h.qacukc4ol1i0)

## [NestJS (Enterprise Backend Development) — MERN Stack Interview Kit](#h.dgwr73ugmgjx)

[1\. Introduction to NestJS & Architecture](#h.r0uw76h8bpo3)  
[2\. Controllers, Modules, and Providers](#h.2ojmflfd455e)  
[3\. Dependency Injection in NestJS](#h.ynt1s9n2qa6t)  
[4\. Configuration Management](#h.s0rk50nt927n)  
[Bonus Questions (Added for Complete Coverage)](#h.6q5fgidsw6yl)
...
## **Node.js— MERN Stack Interview Kit**
...
## **Express.js — MERN Stack Interview Kit**
...
**Q1. What is Express.js and why is it used?** `[Fresher]`

* Express.js — minimal, unopinionated web framework for Node.js  
* Sits on top of Node.js built-in `http` module — makes server creation much simpler  
* Why Express over raw Node.js `http`:  
  * Built-in routing — no manual URL parsing  
  * Middleware system — plug in functionality easily  
  * Cleaner request/response API  
  * Huge ecosystem of middleware packages  
  * Less boilerplate code  
* Express is the E in MERN stack  
* Alternatives — Fastify (faster), Koa (lighter), Hapi, NestJS (opinionated, TypeScript-first)  
* Express is unopinionated — no forced folder structure, no forced patterns  
* Used for — REST APIs, GraphQL servers, serving static files, SSR apps

---

**Q2. How do you set up a basic Express server?** `[Fresher]`

* `npm install express`  
* Minimal server setup steps:  
  * `require('express')` / `import express from 'express'`  
  * Call `express()` to create app instance  
  * Define routes — `app.get('/', handler)`  
  * Call `app.listen(port, callback)` — starts HTTP server  
* `app` object — central object, registers middleware and routes  
* `app.listen()` returns an `http.Server` instance — can be used for WebSockets (Socket.io)  
* Port best practice — `process.env.PORT || 3000` — use env var, fallback for local dev  
* Separating `app` from server — define `app` in `app.js`, call `listen` in `server.js`  
  * Why — easier to test (import app without starting server), cleaner separation  
* Entry point naming — `app.js`, `server.js`, or `index.js` — `main` field in `package.json`

---

**Q3. What is the application structure of a well-organized Express project?** `[1-2 yrs]`

* Recommended folder structure for MERN backend:
...
* Controllers — handle request/response, call services/models, should not contain business logic  
* Services layer (optional but recommended) — business logic separate from controllers  
* Why structure matters — maintainability, scalability, testability  
* `app.js` vs `server.js` separation — `app.js` exports Express app, `server.js` calls `app.listen()`
...
**Q4. What is middleware in Express and how does it work?** `[Fresher]`

* Middleware — functions that have access to `req`, `res`, and `next` in the request-response cycle  
* Signature — `(req, res, next) => {}`  
* Middleware executes in order of registration — sequence matters  
...
* If `next()` is not called and response is not sent — request hangs forever  
* `next(err)` — passing an error to next triggers error-handling middleware  
* Middleware pipeline — `req` flows through each middleware top to bottom

---

**Q5. What are the different types of middleware in Express?** `[Fresher]`

* **Application-level middleware** — bound to `app` object via `app.use()` or `app.METHOD()`  
  * Runs for all routes or specified path  
  * `app.use(middleware)` — all routes  
  * `app.use('/api', middleware)` — only routes starting with `/api`  
* **Router-level middleware** — same as application-level but bound to `express.Router()` instance  
* **Built-in middleware:**  
...
* **Third-party middleware:**  
  ...
  * `rate-limiter-flexible` / `express-rate-limit` — request rate limiting  
  * `cookie-parser` — parse Cookie header into `req.cookies`  
  * `multer` — handle multipart/form-data (file uploads)  
  * `express-validator` — input validation middleware  
* **Error-handling middleware** — four parameters `(err, req, res, next)` — must have all four  
* **Route-level middleware** — passed directly to a specific route handler

---

**Q6. How do you write custom middleware in Express?** `[Fresher]`
...
* Common custom middleware examples:  
  ...
  * Auth middleware — verify JWT token, attach user to `req.user`  
  * Request ID — generate unique ID per request, attach to `req.id`  
  * Input sanitizer — trim whitespace from body fields  
  * Role-based access control — check `req.user.role`  
* Middleware with options — return middleware from a factory function:
...
* Order of middleware registration is critical — auth middleware must come before protected routes  
* `req` object is shared across all middleware in a request — attach data with `req.customProperty`

---

**Q7. What is `cors` middleware and why is it needed?** `[1-2 yrs]`

* CORS — Cross-Origin Resource Sharing — browser security mechanism  
* Browser blocks requests from one origin (domain/port) to a different origin by default  
* In MERN — React frontend on `localhost:3000` calling Express backend on `localhost:5000` — CORS error  
* `npm install cors`  
* `app.use(cors())` — allow all origins (okay for development, not production)  
...
* `origin` can be array, function, or regex for multiple allowed origins  
* Preflight request — browser sends `OPTIONS` request before actual request for non-simple requests  
* `credentials: true` — required when frontend sends cookies or Authorization header  
* CORS is a browser enforcement — Postman/curl are not affected by CORS

---

**Q8. What is `helmet` and why should you use it?** `[2-3 yrs]`

* Security middleware — sets various HTTP response headers to protect against common attacks  
* `npm install helmet`  
* `app.use(helmet())` — enables all default protections  
* Headers helmet sets:  
  * `Content-Security-Policy` — prevent XSS by restricting sources of scripts/styles  
  * `X-XSS-Protection` — legacy XSS filter (for older browsers)  
  * `X-Frame-Options` — prevent clickjacking (deny framing in iframes)  
  * `X-Content-Type-Options: nosniff` — prevent MIME type sniffing  
  * `Strict-Transport-Security` — enforce HTTPS (HSTS)  
  * `Referrer-Policy` — control referrer information  
  * Removes `X-Powered-By: Express` — hides tech stack from attackers  
* Individual headers can be enabled/disabled as needed  
* Always use in production Express apps — one line for significant security improvement
...
**Q9. How does routing work in Express?** `[Fresher]`

* Route — mapping of HTTP method \+ URL path to handler function  
* Basic syntax — `app.METHOD(PATH, HANDLER)`  
* HTTP methods — `app.get()`, `app.post()`, `app.put()`, `app.patch()`, `app.delete()`  
* `app.all(path, handler)` — matches all HTTP methods for a path  
* `app.use(path, handler)` — matches all methods, also matches sub-paths  
* Route handler — `(req, res) => {}` — must send a response  
* Multiple handlers per route — `app.get('/path', middleware1, middleware2, handler)`  
* Handler array — `app.get('/path', [middleware1, middleware2], handler)`  
* Route order matters — first matching route wins  
* `app.route('/path')` — chain multiple method handlers:
...
**Q10. What is `express.Router()` and why is it used?** `[Fresher]`

* Mini Express application — has its own middleware and routes  
* Used to modularize routes into separate files  
* Without Router — all routes in one file, becomes unmaintainable  
* Usage:
...
* Router-level middleware — `router.use(middleware)` applies only to that router's routes  
* Routers can be nested — router mounting another router  
* `router.param('id', callback)` — middleware that runs when specific route parameter is present

---

**Q11. What are route parameters, query parameters, and how do you access them?** `[Fresher]`

* **Route parameters** — dynamic segments in URL path, prefixed with `:`  
  * Defined — `app.get('/users/:id')`  
  * Accessed — `req.params.id`  
  * Multiple params — `/users/:userId/posts/:postId` → `req.params.userId`, `req.params.postId`  
  * Optional param — `/users/:id?` — `?` makes it optional  
  * Wildcard — `/files/*` — matches any path starting with `/files/`  
* **Query parameters** — key-value pairs after `?` in URL  
  * URL — `/search?term=node&page=2&limit=10`  
  * Accessed — `req.query.term`, `req.query.page`, `req.query.limit`  
  * Always strings — parse numbers: `parseInt(req.query.page)`  
  * Always validate and sanitize query params  
* **Route params vs Query params:**  
  * Route params — identify a specific resource (`/users/123`)  
  * Query params — filter, sort, paginate a collection (`/users?role=admin&sort=name`)
...
**Q12. What is the `req` (request) object in Express?** `[Fresher]`

* Represents the incoming HTTP request  
* Key properties:  
  * `req.params` — route parameters (`/users/:id` → `req.params.id`)  
  * `req.query` — query string parameters (`?name=john` → `req.query.name`)  
  * `req.body` — request body (requires body-parsing middleware)  
  * `req.headers` — all request headers as object  
  * `req.header('Authorization')` — get specific header (case-insensitive)  
  * `req.method` — HTTP method (`GET`, `POST`, etc.)  
  * `req.url` — request URL including query string  
  * `req.path` — path only, without query string  
  * `req.hostname` — hostname from Host header  
  * `req.ip` — remote IP address of client  
  * `req.protocol` — `http` or `https`  
  * `req.secure` — boolean, true if HTTPS  
  * `req.cookies` — parsed cookies (requires `cookie-parser`)  
  * `req.get(header)` — get request header value  
  * `req.is(type)` — check Content-Type (`req.is('application/json')`)  
* Custom properties — middleware attaches data to `req` (`req.user`, `req.requestId`)

---

**Q13. What is the `res` (response) object in Express?** `[Fresher]`

* Represents the outgoing HTTP response  
* Key methods:  
  * `res.send(body)` — send response, auto-sets Content-Type based on body type  
  * `res.json(object)` — send JSON response, sets `Content-Type: application/json`  
  * `res.status(code)` — set status code (chainable — `res.status(404).json({...})`)  
  * `res.sendStatus(code)` — set status code AND send status text as body  
  * `res.redirect(url)` — redirect client (default 302), `res.redirect(301, url)` for permanent  
  * `res.render(view, data)` — render template (for server-side rendering with template engines)  
  * `res.sendFile(path)` — send a file as response  
  * `res.download(path, filename)` — send file as download attachment  
  ...
  * `res.locals` — object to pass data to templates (scoped to request)  
* Chaining — `res.status(201).json({ message: 'Created' })`  
* Can only send one response per request — sending twice throws `Cannot set headers after they are sent`
...
**Q14. How does error handling work in Express?** `[1-2 yrs]`

* Express has a special error-handling middleware with four parameters — `(err, req, res, next)`  
* Must have all four parameters — Express identifies it as error handler by parameter count  
* Register AFTER all routes and regular middleware — order is critical  
* How errors reach it:  
  * `next(err)` — pass error from any middleware or route handler  
  * Thrown errors in synchronous code — Express catches automatically  
  * Async errors — must be caught and passed to `next(err)` manually (or use express-async-errors)  
* Basic error handler:
...
* `express-async-errors` package — patches Express to auto-catch async errors, no try/catch needed  
* Custom error classes — extend `Error` with `status` property for clean error creation

---

**Q15. What is the difference between operational errors and programmer errors in Express?** `[2-3 yrs]`

* Already covered in Node.js section — Express-specific patterns:  
* Operational errors — invalid input, DB record not found, unauthorized access — return proper HTTP status  
* Programmer errors — null reference, type error — log and return 500  
* 404 handler — catch-all for unmatched routes, register BEFORE error handler but AFTER all routes:

 app.use((req, res, next) \=\> {  
    next(createError(404, \`Route ${req.url} not found\`))  
  })

* `http-errors` package — create HTTP errors easily: `createError(404, 'Not found')`  
* Error response format — be consistent across all endpoints:

json  
 { "success": false, "message": "Resource not found", "errors": \[\] }

* In development — include `err.stack` in response for debugging  
* In production — never expose stack trace to client

---

**Q16. How do you handle async errors in Express route handlers?** `[1-2 yrs]`

* Problem — `async` route handlers that throw are NOT caught by Express automatically (Express 4\)  
* Manual approach — wrap every async handler in try/catch and call `next(err)`  
* Wrapper utility — asyncHandler / catchAsync:
...
* `express-async-errors` — `require('express-async-errors')` at top of app, patches Express automatically  
* Express 5 (currently in beta) — handles async errors natively, no wrapper needed  
* Best practice in MERN — use asyncHandler wrapper or `express-async-errors` package

---

### **6\. RESTful APIs & CRUD Operations**

---

**Q17. What is REST and what are RESTful API principles?** `[Fresher]`

* REST — Representational State Transfer — architectural style for APIs  
* Six constraints of REST:  
  * **Stateless** — each request contains all info needed, server stores no client session state  
  * **Client-Server** — frontend and backend are separate concerns  
  * **Uniform Interface** — consistent resource naming, HTTP methods, response formats  
  * **Cacheable** — responses should indicate if they can be cached  
  * **Layered System** — client doesn't know if it's talking directly to server or intermediary  
  * **Code on Demand** (optional) — server can send executable code to client  
* REST is not a protocol — it's a set of guidelines  
* RESTful API — API that follows REST constraints  
* Resource-based URLs — `/users`, `/users/123`, `/users/123/posts` — nouns not verbs  
* HTTP methods define the action — not the URL

---

**Q18. How do HTTP methods map to CRUD operations in a RESTful API?** `[Fresher]`

| HTTP Method | CRUD Operation | Use Case | Idempotent |
| ----- | ----- | ----- | ----- |
| GET | Read | Fetch resource(s) | Yes |
| POST | Create | Create new resource | No |
| PUT | Update (full) | Replace entire resource | Yes |
| PATCH | Update (partial) | Update specific fields | No (can be) |
| DELETE | Delete | Remove resource | Yes |

* Idempotent — calling same request multiple times produces same result  
* `GET` — never modify data, safe and idempotent  
* `POST` — creates resource, calling twice creates two resources (not idempotent)  
* `PUT` vs `PATCH`:  
  * `PUT` — send entire object, replaces everything  
...
| `/api/users/:id` | PUT | Replace user |
| `/api/users/:id` | PATCH | Update user fields |
| `/api/users/:id` | DELETE | Delete user |

---

**Q19. How do you structure CRUD operations in Express with controllers?** `[1-2 yrs]`

* Separate concerns — routes define paths, controllers handle logic  
* Route file — thin, just maps URLs to controller functions  
* Controller file — handles req/res, calls models/services  
* Controller pattern:
...
* Services layer (optional) — business logic in separate service files, controllers call services  
* Why this matters — separation of concerns, testability, readability

---

### **7\. Request Body & Query Parameters**

---

**Q20. How do you handle request body in Express?** `[Fresher]`

* `req.body` is `undefined` by default — need body parsing middleware  
* `express.json()` — parses `application/json` body  
  * `app.use(express.json())` — register globally  
  * `limit` option — `express.json({ limit: '10mb' })` — max body size  
* `express.urlencoded({ extended: true })` — parses `application/x-www-form-urlencoded` (HTML form data)  
  * `extended: true` — uses `qs` library, supports nested objects  
  * `extended: false` — uses `querystring` library, flat key-value only  
* `multer` — for `multipart/form-data` (file uploads) — `express.json` cannot handle this  
* `raw` and `text` parsers — `express.raw()`, `express.text()` for raw body  
* Content-Type header — client must set correct Content-Type for parser to work  
* Common mistake — registering `express.json()` AFTER routes — body will be undefined

---

**Q21. How do you handle query parameters in Express?** `[Fresher]`

* `req.query` — automatically parsed by Express, no middleware needed  
* URL `/products?category=shoes&sort=price&order=asc&page=2&limit=10`  
* Access — `req.query.category`, `req.query.sort`, `req.query.page`  
* Always strings — convert types explicitly:  
  * `parseInt(req.query.page) || 1`  
  * `req.query.active === 'true'`  
* Default values — always provide defaults for pagination: `const page = parseInt(req.query.page) || 1`  
* Array query params — `/items?ids=1&ids=2&ids=3` → `req.query.ids = ['1','2','3']`  
* Common query param patterns in REST APIs:  
  * Pagination — `?page=1&limit=10`  
  * Sorting — `?sort=createdAt&order=desc`  
  * Filtering — `?status=active&role=admin`  
  * Search — `?search=john`  
  * Field selection — `?fields=name,email`  
* Sanitize query params — never directly pass to DB query without validation

---

### **8\. HTTP Status Codes & Response Handling**

---

**Q22. What are HTTP status codes and which ones are most important?** `[Fresher]`
...
* 401 vs 403 — common interview question:  
  * 401 — you are not logged in (who are you?)  
  * 403 — you are logged in but not allowed (I know who you are, but no)

---

**Q23. How do you structure consistent API responses in Express?** `[1-2 yrs]`

* Consistent response format — same structure for all endpoints  
...
* Response utility function — centralize response format:
...
* Why consistency matters — frontend can always rely on same shape, easier error handling in React  
* Pagination metadata — always include `total`, `page`, `limit`, `totalPages` in list responses

---

**Q24. What is the difference between `res.send()`, `res.json()`, and `res.end()`?** `[Fresher]`

* `res.send(body)`:  
  * Accepts string, Buffer, object, array  
  * If object/array — automatically converts to JSON and sets `Content-Type: application/json`  
  * If string — sets `Content-Type: text/html`  
  * Sets `Content-Length` automatically  
* `res.json(data)`:  
  * Always sends JSON  
  * Always sets `Content-Type: application/json`  
  * Runs `JSON.stringify()` with Express settings (respects `app.set('json spaces', 2)`)  
  * Handles `undefined`, functions (converts to `null`) — `res.send` would behave differently  
  * Preferred for API responses — explicit and clear intent  
* `res.end()`:  
  * Raw Node.js method — no content-type, no processing  
  * Used to end response without sending any data  
  * No automatic JSON conversion  
  * Use for streaming or when you need raw control  
* Best practice — always use `res.json()` for REST API responses
...
**Q25. What is rate limiting and how do you implement it in Express?** `[2-3 yrs]`

* Rate limiting — restricts number of requests a client can make in a time window  
* Prevents abuse, brute force attacks, DoS attacks  
* `express-rate-limit` — most common package  
* Basic setup:
...
* Separate stricter limits for auth routes — login, register, forgot-password  
* `X-RateLimit-Limit`, `X-RateLimit-Remaining`, `X-RateLimit-Reset` — response headers  
* In production with multiple servers — use Redis store (`rate-limit-redis`) so limits are shared across instances

---

**Q26. How do you implement input validation in Express?** `[1-2 yrs]`

* Never trust client input — always validate and sanitize on server  
* `express-validator` — most popular validation library for Express  
* `zod` or `joi` — schema-based validation, framework-agnostic  
* Validation middleware pattern:

 const { body, validationResult } \= require('express-validator')

  const validateUser \= \[body('email').isEmail().normalizeEmail(),  
...
* Sanitization — `trim()`, `escape()`, `normalizeEmail()` — clean input alongside validation  
* Validate params and query too — not just body  
* Validation vs sanitization:  
  * Validation — check if input meets requirements, reject if not  
  * Sanitization — clean/transform input (trim whitespace, lowercase email)

---

**Q27. How do you serve static files in Express?** `[Fresher]`

* `express.static(root, options)` — built-in middleware to serve static files  
* `app.use(express.static('public'))` — serves files from `public/` directory  
* Accessing — `http://localhost:3000/image.png` serves `public/image.png`  
* Mount path — `app.use('/static', express.static('public'))` — prefix URL with `/static`  
* Options — `maxAge` for caching, `index` for default file, `dotfiles` handling  
...
* `*` catch-all route — for React Router (client-side routing), serve `index.html` for all non-API routes  
* Register static middleware BEFORE routes for performance

---

**Q28. What is the difference between `app.use()` and `app.get()`?** `[Fresher]`

* `app.use(path, middleware)`:  
  * Matches ALL HTTP methods  
  * Path matching is prefix-based — `/api` matches `/api`, `/api/users`, `/api/users/123`  
  * If no path — matches all routes  
  * Used for middleware, not route handlers  
* `app.get(path, handler)`:  
  * Matches only GET requests  
  * Path must match exactly (with route param patterns)  
  * Used for defining specific routes  
* `app.use` vs `app.all`:  
  * `app.use('/api')` — prefix match, `/api/users` matches  
  * `app.all('/api')` — exact match, `/api/users` does NOT match  
* Middleware registered with `app.use` before routes applies to all subsequent routes  
* Middleware registered with `app.use` after routes never executes for those routes

---

**Q29. How do you implement file uploads in Express?** `[2-3 yrs]`

* `multer` — middleware for handling `multipart/form-data`  
* `npm install multer`  
* Storage options:  
  * `multer.memoryStorage()` — store in memory as Buffer (good for small files, cloud upload)  
  * `multer.diskStorage()` — store on disk with custom filename and destination  
* Basic setup:
 ...
 const multer \= require('multer')  
  ...
  router.post('/upload', upload.single('avatar'), (req, res) \=\> {  
    // req.file — uploaded file info (buffer, originalname, mimetype, size)  
    // req.files — for multiple files })  

* File validation — check `mimetype` and `size` in `fileFilter` option  
* Cloud upload pattern — use memory storage, then upload `req.file.buffer` to AWS S3 or Cloudinary  
* `upload.single('field')` — one file, `upload.array('field', maxCount)` — multiple files, `upload.fields([...])` — multiple fields

---

**Q30. What is Express middleware execution order and why does it matter?** `[1-2 yrs]`

* Express processes middleware in exact order of registration — top to bottom  
* Critical ordering rules:  
  * Security middleware first — `helmet()`, `cors()`  
  * Body parsers — `express.json()`, `express.urlencoded()`  
  * Request logging — `morgan()`  
  * Authentication middleware — if needed globally  
  * Routes  
  * 404 handler — after all routes  
  * Error handler — always last  
* Common bugs from wrong order:  
  * `express.json()` after routes → `req.body` is undefined  
  * Error handler before routes → errors not caught  
  * CORS after routes → CORS headers missing on responses  
  * Auth middleware after protected routes → routes unprotected  
* `next()` is the key — if any middleware doesn't call `next()` and doesn't send response, request hangs

---

That's the complete **Express.js** section — **30 questions** with full subtopic depth, ready to merge into your MERN Interview Kit.
...
That's the complete Authentication & Authorization section — 20 questions with full subtopic depth, ready to merge into your MERN Interview Kit.
...
That's the complete Advanced Express.js section — 24 questions with full subtopic depth, ready to merge into your MERN Interview Kit.
...
That is the complete NestJS section — 19 questions with full subtopic depth, ready to merge into your MERN Interview Kit.
...
That is the complete Building REST APIs section — 20 questions with full subtopic depth, ready to merge into your MERN Interview Kit.
...
That is the complete Database & ORM, Authentication & Security (NestJS patterns), and Advanced Topics sections — combined total of 30 questions with full subtopic depth, ready to merge into your MERN Interview Kit.
